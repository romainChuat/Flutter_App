            ...
            child: Column(
              ...
              children: <Widget>[
                                ...
                                child:RadioListTile(
                                  ...
                                  onChanged: (value) { 
                                    setState(() {
                                      genre = Genre.feminin;
                                      print(genre);
                                      reponses['genre'] = genre.toString().split('.').last;
                                      print(reponses);
                                    });
                                  }, 
                                  value: 10,
                ...
                Row(
                 ...
                 mylib.createNextButton("Next", context, 141, 41, MaterialPageRoute(builder: (_) => etudePage(), settings: RouteSettings(arguments: reponses)), )
                  ],
                )
              ],
            ),
